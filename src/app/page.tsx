...
export default function Home() {
  ...
  return (
    <div className="flex flex-col overflow-hidden bg-[#050816]">
      ...
      <section className="relative w-full pt-24 pb-20 lg:pt-36 lg:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
          <div className="space-y-8 text-center lg:text-left">
            <Badge variant="outline" className="border-primary/30 text-primary py-1.5 px-6 text-sm glass uppercase tracking-[0.2em] font-bold">
              ✨ Redefining Tech Education
            </Badge>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-headline font-extrabold leading-[1.05]">
              Master <span className="text-gradient">AI.</span><br />
              Build Software.
            </h1>
            <p className="max-w-xl text-lg md:text-xl text-muted-foreground leading-relaxed mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 pt-4">
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90 rounded-full px-10 text-lg font-bold transition-all hover:scale-105 neon-glow">
                <Link href="https://www.youtube.com/@guruphoria" target="_blank">
                  <Youtube className="mr-2 h-5 w-5" /> Watch Tutorials
                </Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="rounded-full px-10 text-lg font-bold glass hover:bg-white/5 border-white/10 transition-all">
                <Link href="/courses">
      ...
      <section className="py-24 bg-[#050816]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl md:text-5xl font-bold">Explore <span className="text-primary">Featured Topics</span></h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">Master the stack that builds the future of autonomous intelligence.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {featuredTopics.map((topic) => (
              <Card key={topic.name} className="glass p-8 text-center group hover:border-primary/50 transition-all duration-500 bg-[#101828]/50 border-white/5 flex flex-col items-center justify-center gap-4 cursor-pointer hover:-translate-y-2">
                <div className={`${topic.color} group-hover:scale-125 transition-transform duration-500`}>
                  {topic.icon && <span className="[&>svg]:w-10 [&>svg]:h-10">{topic.icon}</span>}
                </div>
                <h3 className="font-bold text-sm tracking-tight">{topic.name}</h3>
              </Card>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 bg-[#101828]/20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6">
          <div className="glass rounded-[3rem] p-8 lg:p-16 border-white/5 bg-gradient-to-br from-[#101828]/60 to-transparent">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="relative group max-w-md mx-auto lg:max-w-none w-full">
                <div className="relative glass rounded-3xl p-3 overflow-hidden border-white/10 shadow-2xl transition-transform group-hover:scale-[1.02] duration-500">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end">
                    <div className="space-y-1">
                      <p className="text-xl font-bold text-white">Puneet Shivaay</p>
                      <p className="text-sm text-primary font-bold">SDE & AI Educator</p>
                    </div>
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <h2 className="text-4xl md:text-5xl font-bold leading-tight">Bridging the Gap Between <span className="text-primary">Theory & Production</span></h2>
                ...
                <div className="grid grid-cols-2 gap-8">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground uppercase tracking-widest font-bold">Deep Dive Labs</p>
                  </div>
                </div>
                <div className="flex gap-4 pt-4">
                  <Button asChild size="lg" className="rounded-full bg-primary font-bold transition-all hover:scale-105">
                    <Link href="/about">Read My Story</Link>
                  </Button>
                  <Button asChild size="lg" variant="ghost" className="rounded-full text-white hover:text-primary transition-colors font-bold">
            ...
            <div className="space-y-8">
              <div className="flex items-center justify-between">
                <h2 className="text-3xl font-bold flex items-center gap-3">
                  <Youtube className="text-[#EA3323] h-8 w-8" /> Latest Labs
                </h2>
                <Button asChild variant="ghost" className="text-sm font-bold text-muted-foreground hover:text-primary transition-colors">
                ...
                {isLoadingVideos ? (
                  ...
                  videos.map((video) => (
                    <Card key={video.id} className="glass overflow-hidden group bg-[#101828]/50 border-white/5 hover:border-primary/30 transition-all duration-500">
                      ...
                      <div className="p-6 space-y-3">
                        <h4 className="font-bold text-lg line-clamp-2 group-hover:text-primary transition-colors leading-snug">{video.title}</h4>
              ...
              <div className="grid gap-6">
                {isLoadingArticles ? (
                  ...
                  articles.map((article) => (
                    <Card key={article.id} className="glass p-6 flex gap-6 group bg-[#101828]/50 border-white/5 hover:border-primary/30 transition-all duration-500">
      ...
      <section className="w-full py-24 bg-[#101828]/30">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl md:text-5xl font-bold">Open Source <span className="text-primary">Labs</span></h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">Production-grade tools and experimental AI frameworks available for everyone.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {isLoadingRepos ? (
              ...
              repos.map((repo) => (
                <Card key={repo.name} className="glass p-8 group hover:border-primary/50 transition-all duration-500 bg-[#101828]/50 border-white/5 hover:-translate-y-2">
                  ...
                  <h3 className="text-2xl font-bold mb-4 line-clamp-1">{repo.name}</h3>
                  <p className="text-muted-foreground text-sm mb-6 line-clamp-2 leading-relaxed">{repo.description}</p>
                  ...
                  <div className="flex gap-4">
                    <Button asChild variant="outline" size="sm" className="flex-1 glass border-white/10 hover:bg-white/5 font-bold rounded-full">
                      <Link href={repo.url} target="_blank">
                        <Github className="mr-2 h-4 w-4" /> Code
                      </Link>
                    </Button>
                    <Button size="sm" className="flex-1 bg-primary/10 text-primary hover:bg-primary/20 border border-primary/20 font-bold rounded-full">
      ...
      <section className="w-full py-24 pb-32">
        <div className="container mx-auto px-6">
          <Card className="glass p-12 lg:p-24 relative overflow-hidden text-center max-w-5xl mx-auto rounded-[4rem] bg-gradient-to-br from-[#101828]/80 to-transparent border-white/10 shadow-[0_0_80px_rgba(14,165,255,0.1)]">
            ...
            <div className="relative z-10 space-y-10 max-w-3xl mx-auto">
              <div className="inline-flex p-5 rounded-3xl bg-primary/10 text-primary mb-2 animate-bounce">
                <Sparkles className="h-10 w-10" />
              </div>
              <h2 className="text-4xl md:text-6xl font-bold leading-[1.1] tracking-tight">Stay Ahead in the <br /><span className="text-primary">AI Revolution</span></h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6 max-w-lg mx-auto">
                <input 
                  type="email" 
                  placeholder="name@email.com" 
                  className="flex-grow bg-white/5 border border-white/10 rounded-full px-8 py-5 outline-none focus:border-primary/50 transition-colors text-white text-lg font-medium backdrop-blur-md"
                  required
                />
                <Button className="bg-primary hover:bg-primary/90 rounded-full px-12 py-5 h-auto text-lg font-bold transition-all hover:scale-105 neon-glow">
                  Join Now
                </Button>
              </div>
              <p className="text-xs text-muted-foreground/60 font-bold uppercase tracking-widest">Weekly technical deep dives • No spam • Ever</p>
            </div>
          </Card>
        </div>
      </section>
