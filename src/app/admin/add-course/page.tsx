...
/**
 * @fileOverview Disabled stub for the add course page.
 */
    ...
    <div className="container mx-auto px-6 py-40 text-center min-h-screen bg-[#050816] text-white">
      <div className="max-w-md mx-auto space-y-8 glass p-12 rounded-[2rem] border-white/5">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-headline font-bold">Access Denied</h1>
          <p className="text-muted-foreground leading-relaxed">
            The "Add Tutorial" feature is not available in the public prototype of the Guruphoria platform.
          </p>
        </div>
